 ...
 */
const easeOut = function (t: number) {
  return -Math.cos(t * Math.PI) / 2 + 0.5
}
// linear
const linear = function (t: number) {
  return t
}
...
const easeOutQuad = function (t: number) {
  return t * (2 - t)
}
...
// accelerating from zero velocity
const easeInQuart = function (t: number) {
  return t * t * t * t
}
// decelerating to zero velocity
...
// accelerating from zero velocity
const easeInQuint = function (t: number) {
  return t * t * t * t * t
}
// decelerating to zero velocity
const easeOutQuint = function (t: number) {
  return 1 + --t * t * t * t * t
}
// acceleration until halfway, then deceleration
const easeInOutQuint = function (t: number) {
